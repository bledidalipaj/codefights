...
"""
def AlphabetStudy(letters, word):
	for letter in word:
...
def AlphabetStudy(letters, word):
	return word.strip(letters) and "No" or "Yes"

AlphabetStudy = lambda letters, word: ["No", "Yes"][all(letter in letters for letter in word)]
AlphabetStudy = lambda letters, word: ["No", "Yes"][set(letters) >= set(word)]